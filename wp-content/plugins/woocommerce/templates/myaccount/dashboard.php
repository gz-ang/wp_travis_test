...
<?php
	...
	if ( $ipartner ) {
		...
		/*Ipartner Application PRO
		echo '<h2>iPartner Pro Link</h2>';
		echo '<table><tr><td><a href="https://arissto.com/my/ipartner-application-pro/?ref=' . wp_get_current_user()->user_login . '" target="_blank"><img src="https://arissto.com/my/wp-content/uploads/pro-machine-desktop-01.jpg"/></a></td></tr></table>';
		*/
